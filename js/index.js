...
const projectHiddenText = document.querySelectorAll(
   ".project__hidden_description"
);
const marqueeContentContainer = document.querySelector(
   ".marquee__content_container"
);
